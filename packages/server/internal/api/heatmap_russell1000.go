...
// russell1000Universe contains approximately the 1000 largest US stocks by market cap.
// Includes all S&P 500 constituents plus additional large-cap stocks.
// Sourced from NASDAQ screener data, filtered for US equities.
var russell1000Universe = map[string]string{
	...
	"MTCH": "Information Technology",
	"MANH": "Information Technology",
	"ORA": "Utilities",
	"BRKR": "Industrials",
	"RYAN": "Financials",
	"PRI": "Financials",
	"ENS": "Information Technology",
	"FR": "Real Estate",
	"AGCO": "Industrials",
